...
public class Main {
    ...
    public static void main(String[] args){
        ...
        Task3.Box<Apple> boxWithApples = new Box<>();
        Task3.Box<Apple> boxWithApples2 = new Box<>();
        Task3.Box<Orange> boxWithOranges = new Box<>();
        Task3.Box<Orange> boxWithOranges2 = new Box<>();
